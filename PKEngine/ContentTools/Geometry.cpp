...
namespace pk::tools
{
    namespace
    {
        ...
        void recalculate_normals(mesh& m)
        {
            ...
            {
                const u32 i0 { (u32)m.raw_indices[i] };
                const u32 i1 { (u32)m.raw_indices[++i] };
                const u32 i2 { (u32)m.raw_indices[++i] };
