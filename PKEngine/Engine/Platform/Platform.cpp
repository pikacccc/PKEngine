...
namespace pk::platform
{
    ...
    namespace
    {
        ...
        void* get_window_handle(window_id window_id)
        {
            return get_from_id(window_id).hwnd;
        }
    ...
    window create_window(const window_init_info* const init_info)
    {
        ...
        wc.hbrBackground = CreateSolidBrush(RGB(26, 58, 76));
        wc.lpszMenuName = NULL;
        wc.lpszClassName = L"PKWindow";
        ...
        window_info info{};
        info.client_area.right = init_info && init_info->width
                                     ? info.client_area.left + init_info->width
                                     : info.client_area.right;
        info.client_area.bottom = init_info && init_info->height
